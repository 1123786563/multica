...
- **前端**：[http://localhost:3300](http://localhost:3300)
- **后端**：[http://localhost:8280](http://localhost:8280)
...
打开 [http://localhost:3300](http://localhost:3300)：
...
```bash
multica setup self-host --server-url http://<你的服务器地址>:8280 --app-url http://<你的服务器地址>:3300
```
...
默认连 `http://localhost:8280`（backend）+ `http://localhost:3300`（frontend）。
