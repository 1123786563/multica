...
| `PORT` | `8280` | No (unless you change the port) |
...
| `GOOGLE_REDIRECT_URI` | `http://localhost:3300/auth/callback` | OAuth callback URL (self-host: replace with your frontend domain) |
...
| Variable | Default | Description |
|---|---|---|
| `MULTICA_SERVER_URL` | `ws://localhost:8280/ws` | Server address (self-host: replace with your domain) |
