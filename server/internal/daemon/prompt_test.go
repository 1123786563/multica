...
func TestBuildOrchestrationNodePrompt(t *testing.T) {
	task := Task{
		...
		Orchestration: &OrchestrationContext{
			...
			PriorEvidenceSummary: "Previous agent summary: I completed the whole issue.\nKernel reason: evidence_insufficient",
			ChangeRequest:        "Return schema_version and criteria_evidence.",
	...
	mustContain := []string{
		...
		"Return schema_version and criteria_evidence.",
